    ...
    <div class="container" style="background: white;padding: 0px;border-left: 1px solid black;border-right: 1px solid black;  ">
        ...
        <div class="row">
            ...
            <form style="width: 100%;" method="post">
                <textarea style="font-size: 1.2em;overflow: hidden;width: 80%;resize: none;outline: none" name="comment" id="text" placeholder="Написать комментарий" ></textarea>
                <input style="margin-bottom: 23px" class="btn btn-dark" type="submit" name="submit" >
            </form>
            </div>
        </div>
        <div class="row" >
            ...
            <div class="col-sm-offset-1 col-md-10" style="  border-radius: 10px;background:#ebe8ec;padding: 10px;margin-bottom: 10px">
                ...
                <div class=" col-sm-11" style="padding: 0px">
                    ...
                    <div class="row" style="border-radius: 10px;background: white;padding: 5px">
                        <p> Какойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментарияКакойто там текст коментария</p>
                    </div>
                    <div class="row">
                        <a href="#">
