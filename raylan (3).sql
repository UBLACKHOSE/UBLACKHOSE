...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 23 2021 г., 04:44
...
CREATE TABLE `invoices` (
  ...
  `category` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Нет',
...
(1, 1, 424.23, 12321421, '2020-09-07', '2021-09-10', 'Взнос', 'Лицевой счет', 'Решение Общего собрания садоводов - членов СНТ от 25.01.2014', 'Членский взнос 2014г. 5000 руб. за участок', 'Нет', 1),
...
(17, 1, 123, 123, '2021-04-22', '2021-04-25', '123', '123', '123', '123', 'Нет', 0);
...
(6, '123', '123', '2021-04-21', 'UBLACKHOSE', 'post_2.png'),
(7, '123', '123', '2021-04-21', 'UBLACKHOSE', 'img_3.png');
...
INSERT INTO `users` (`id`, `login`, `email`, `password`, `img`, `balance`, `street_id`, `status`) VALUES
(1, 'UBLACKHOSE', 'veselovdima394@gmail.com', 'GogaMoga29', 'img_6.png', 176.39, 1, 1),
(4, 'User2', 'User2@mail.ru', 'password', '0.png', 0, 2, 0);
